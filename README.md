...
### ***Description***
#### Animal Care Center is a web site where clinics can list their products, services, and animals for adoption.
#### The users can adopt animals, make orders to buy the products from the clinics, and set an appointments for their pets in a selected clinic.
***
